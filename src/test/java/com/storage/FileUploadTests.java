...
public class FileUploadTests {
	...
	/**
	 * Mock for mvc interactions entity
	 */
    @Autowired
    private MockMvc mvc;
    ...
    /**
     * Test the file rendering from the server to mvc page
     * @throws Exception if storage service files
     */
    @Test
    ...
    /**
     * Tests the file save from an mvc upload
     * @throws Exception if storage service files
     */
    @Test
    ...
    /**
     * Tests the missing file error from mvc page
     * @throws Exception if storage service files
     */
    @Test
